...
public class FullyQualifiedTable
{
	...
	public FullyQualifiedTable(String introspectedCatalog,
			...
			boolean delimitIdentifiers, IbatorContext ibatorContext)
	{
		super();
		...
		beginningDelimiter = delimitIdentifiers ? ibatorContext
				.getBeginningDelimiter() : ""; //$NON-NLS-1$
		endingDelimiter = delimitIdentifiers ? ibatorContext
				.getEndingDelimiter() : ""; //$NON-NLS-1$
	}
	...
	public String getFullyQualifiedTableNameAtRuntime()
	{
		...
		return StringUtility.composeFullyQualifiedTableName(
				localCatalog.toString(), localSchema.toString(),
	...
	public String getDomainObjectName()
	{
		if (StringUtility.stringHasValue(domainObjectName))
		{
			...
			{
				return JavaBeansUtil.getCamelCaseString(introspectedTableName,
						true);
			}
	}
