		...
		AbstractXmlElementGenerator
{
	...
	public void addElements(XmlElement parentElement)
	{
		...
		answer.addAttribute(new Attribute(
				"id", introspectedTable.getIbatis2SqlMapNamespace() + "." + introspectedTable.getInsertSelectiveStatementId())); //$NON-NLS-1$
				...
				.getAllColumns())
		{
			...
			valuesNotNullElement.addAttribute(new Attribute(
					"property", introspectedColumn.getJavaProperty())); //$NON-NLS-1$
			valuesNotNullElement.addElement(new TextElement("<![CDATA[ "
					+ Ibatis2FormattingUtilities
		...
		if (ibatorContext.getPlugins().sqlMapInsertSelectiveElementGenerated(
