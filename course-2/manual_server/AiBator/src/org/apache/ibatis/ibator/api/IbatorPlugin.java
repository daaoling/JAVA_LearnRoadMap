 ...
 * times during the code generation process. These methods can be used to extend
 * or modify the code generated by Ibator. Clients may implement this interface
 * in its entirety, or extend the IbatorPluginAdapter (highly recommended).
 * <p>
 ...
 * </ol>
 * Plugins are related to Ibator contexts - so each context will have its own
 * set of plugins. If the same plugin is specified in multple contexts, then
 * each context will hold a unique instance of the plugin.
 * <p>
 * Plugins are called, and initialized, in the same order they are specified in
 * the configuration.
 * <p>
 * The daoXXX, modelXXX, and sqlMapXXX methods are called by the code generators
 * supplied with Ibator. If you replace Ibator's default code generators with
 * other implementations, these methods may not be called.
 * 
 * @author Jeff Butler
...
public interface IbatorPlugin
{
	 ...
	 *            reported to users after the completion of the Ibator run.
	 ...
	 * 
	 * @return a List of GeneratedJavaFiles - Ibator will persist these files
	 *         with the other files from this run of Ibator.
	 */
	 ...
	 * 
	 * @param introspectedTable
	 *            Ibator's class containing information about the table as
	 ...
	 * files have been generated.
	 * 
	 * @return a List of GeneratedXmlFiles - Ibator will persist these files
	 *         with the other files from this run of Ibator.
	 */
	 ...
	 *            Ibator's class containing information about the column related
	 ...
	 * Ibator supplied JavaModelGenerator. This method will only be called if
	 * the table rules call for generation of a primary key class.
	 * <p/>
	 * This method is only guaranteed to be called by the Ibator supplied Java
	 ...
	 * the Ibator supplied JavaModelGenerator. This method will only be called
	...
	/**
	 * This method is called after the example class is generated by the Ibator
	 * supplied JavaModelGenerator. This method will only be called if the table
	 ...
	 * 
	 * @param document
	 *            the generated document (note that this is Ibator's internal
