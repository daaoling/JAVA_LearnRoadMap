...
public interface IbatorRules
{
	 ...
	 * updateByExample, or countByExample statements are allowed. In iBATIS3,
	 * generate the element if the selectByExample, deleteByExample, or
	...
	/**
	 * Implements the rule for generating the SQL example where clause element
	 * specifically for use in the update by example methods. In iBATIS2, do not
	 * generate the element. In iBATIS3, generate the element if the
