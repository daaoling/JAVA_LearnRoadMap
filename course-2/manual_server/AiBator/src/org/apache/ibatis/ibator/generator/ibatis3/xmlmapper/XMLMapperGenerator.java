...
public class XMLMapperGenerator extends AbstractXmlGenerator
{
	...
	protected void addIbatis3UpdateByExampleWhereClauseElement(
			XmlElement parentElement)
	{
		if (introspectedTable.getRules()
				.generateIbatis3UpdateByExampleWhereClause())
		{
			AbstractXmlElementGenerator elementGenerator = new ExampleWhereClauseElementGenerator(
					true);
			initializeAndExecuteGenerator(elementGenerator, parentElement);
	...
	public Document getDocument()
	{
		...
		if (!ibatorContext.getPlugins().sqlMapDocumentGenerated(document,
				introspectedTable))
		{
			document = null;
		}
